...
%%  
%%  1. Update changelog (see details there) 
%%  
%%  2. Append a + after version number. 
%%  
%%  3. Set \releaseDate to Unreleased. 
%%  
%%  Releasing guideline
%%  
...
\lstdefinelanguage{jmjp-ebnf}{% 
	...
	,morekeywords={% Format 5 per row in dictionary order for readability
		...
		,frameHonba,frameId,frameNum,frameSeq,frameWind% 
		,framesRecd,furoAnk,furoChi,furoDmk,furoKan% 
		,furoKkn,furoPon,hand,kyoutak,lname%
		,match,matchDate,matchDayOfWk,matchNumInDay,matchNumInStage% 
		,matchPlace,matchTP,matchTime,name,numTiles% 
		...
		,strRoman,tileChiHand,tileChiIn,tileFrom,tileFuro% 
		,tileInHand,tileTsumo,tourInfo,tourName,tourStage% 
	...
	,moreemph={|,=}% 
	,basicstyle={\ttfamily}% 
	,keywordstyle={\color{ckey}\itshape}% 
...
% 
\newcommand*{\indexKeywords}[1]{\index{\texttt{#1}}}% 
% 
%Layout and style
\usepackage[% 
	driver=xetex% 
...
\colorlet{ckey}{DarkRed!90!White}% 
\colorlet{cstr}{DarkGreen!90!White}% 
\colorlet{copt}{DarkBlue!90!White}% 
\colorlet{cdel}{Black!90!White}% 
% 
\usepackage{multicol}% 
