...
%%  %%  
	\begin{version}[% 
		...
		\added{}% 
			\item{}Added additional field \lstinline/ptTenpai/ in \lstinline/ptRule/. % 
			\item{}Added representation type \lstinline/diceTotal/ for dice results of frames. % 
			\item{}Added requirement for software to be able to parse all shorthand tokens in a supported version. % 
